...
<?=template_header('Delete')?>
    ...
    <div class="delete text-center">
        <h2 class="section-title">Delete About #<?php echo $about['id']?></h2>
        <?php if ($msg): ?>
            <p><?php echo $msg?></p>
            <div class="row">
                <div class="col-md-12">
        ...
        <?php else: ?>
            <p>Are you sure you want to delete about #<?php echo $about['id']?>?</p>
            <div class="yesno">
                <a href="delete.php?id=<?php echo $about['id']?>&confirm=yes">Yes</a>
                <a href="delete.php?id=<?php echo $about['id']?>&confirm=no">No</a>    
            </div>
        <?php endif; ?>
    </div>
