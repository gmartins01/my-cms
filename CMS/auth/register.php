...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO users (name,username, password,id_me,id_role) VALUES (:name ,:username, :password,1,3)";
...
<body>
    ...
    <section class="vh-100" style="background-color: #5e81ac;">
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        ...
                                        <div class="form-outline mb-3">
                                            ...
                                            <label class="form-label" for="confirm_password">Password repeat</label>
                                        </div>
