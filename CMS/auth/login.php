...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: ../pages/profile/read.php");
    exit;
}
                ...
                if($stmt->rowCount() == 1){
                    if($row = $stmt->fetch()){
                        ...
                        if(password_verify($password, $hashed_password)){
                            ...
                            //redirect
                            if($id_role == 2){
                                header("location: ../pages/contact_requests/read.php");
                            }
                            else if($id_role == 1){
                                header("location: ../pages/profile/read.php");
                            }
                            else{
                                $login_err = "User not yet authorized!";
                            }
                            ...
                            <div class="col-md-6 col-lg-12 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        ...
                                        <div>
                                            <p class="alert alert-danger"><?php echo $login_err?></p>
                                        </div>       
                                        <?php endif; ?>
